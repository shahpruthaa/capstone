      ...
      >
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p className="text-xs" style={{ color: 'var(--text-muted)' }}>
            Disclaimer: This tool is for educational purposes only and uses simulated data.
          ...
          <p className="text-[10px] mt-1" style={{ color: 'var(--text-muted)', opacity: 0.6 }}>
            NSE AI Portfolio Manager · Current prototype assumptions include STCG 20%, LTCG 12.5%, and STT 0.1%.
          </p>
        </div>
      </footer>
