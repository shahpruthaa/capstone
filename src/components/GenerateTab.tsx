            ...
            <div className="lg:col-span-4 space-y-5">
                <div className="card p-4">
                    ...
                    <div className="space-y-5">
                        ...
                        <div>
                            <label className="block text-[10px] font-mono uppercase tracking-wider text-slate-600 mb-1.5">Investment Amount (Rs)</label>
                            <input
                                type="number"
                                value={amount}
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div>
                                <label className="block text-[10px] font-mono uppercase tracking-wider text-slate-600 mb-1.5">Horizon (weeks)</label>
                                <select
                            ...
                            <div>
                                <label className="block text-[10px] font-mono uppercase tracking-wider text-slate-600 mb-1.5">Target Positions</label>
                                <input
                                    type="number"
                        ...
                        <div>
                            <label className="block text-[10px] font-mono uppercase tracking-wider text-slate-600 mb-2">Risk Attitude</label>
                    ...
                    <>
                        <div className="card p-4">
                            <div className="flex items-center justify-between">
                                <div className="text-[10px] text-slate-600 font-mono tracking-wider uppercase font-medium">MODEL GENERATION SUMMARY</div>
                        ...
                        <div className="card p-4">
                            ...
                            <p className="text-[10px] text-slate-600 mt-3 italic">Stop-loss: 15% trailing, STCG: 20%, LTCG: 12.5%</p>
                        </div>
                    </>
                )}
            </div>
                                        ...
                                        {portfolio.allocations.map((allocation, index) => (
                                            ...
                                            >
                                                <td>
                                                    ...
                                                    <div className="text-[10px] font-mono tracking-wide text-slate-600">{allocation.stock.name}</div>
                                                ...
                                                <td>
                                                    <div className="text-xs text-slate-600">
                                                        ...
                                                        <div className="text-[10px] text-slate-600 max-w-52">{allocation.news_explanation ?? 'No mapped news.'}</div>
                                                    </div>
                                                </td>
